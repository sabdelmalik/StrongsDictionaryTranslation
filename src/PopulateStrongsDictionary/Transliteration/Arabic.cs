...
namespace PopulateStrongsDictionary.Transliteration
{
    public class Arabic
    {
        ...
        public const char WAVY_HAMZA_BELOW = '\u065F';  // ٟ';	
        public const char INDIC_DIGIT_ZERO = '\u0660';	// ٠
        public const char INDIC_DIGIT_ONE = '\u0661';	// ١
        public const char INDIC_DIGIT_TWO = '\u0662';	// ٢
        public const char INDIC_DIGIT_THREE = '\u0663';	// ٣
        public const char INDIC_DIGIT_FOUR = '\u0664';	// ٤
        public const char INDIC_DIGIT_FIVE = '\u0665';	// ٥
        public const char INDIC_DIGIT_SIX = '\u0666';	// ٦
        public const char INDIC_DIGIT_SEVEN = '\u0667';	// ٧
        public const char INDIC_DIGIT_EIGHT = '\u0668';	// ٨
        public const char INDIC_DIGIT_NINE = '\u0669';	// ٩
